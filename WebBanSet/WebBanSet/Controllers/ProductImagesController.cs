...
using WebBanSet.Models;

namespace WebBanSet.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        {
            var productDBContext = _context.PI.Include(p => p.Product);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var productImage = await _context.PI
                .Include(p => p.Product)
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var productImage = await _context.PI.FindAsync(id);
            if (productImage == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (productImage != null)
            {
                _context.PI.Remove(productImage);
            }
        ...
        {
            return _context.PI.Any(e => e.Id == id);
        }
    }
}
